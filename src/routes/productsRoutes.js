...
// this method is to render a form which shows edit.ejs with all the data filled for the current product that needs to be updated
...
// to add product we need a form similar to update
